        ...
        <div class="card"style="width:100%">
            <div class="card-header" style="background-color:#4A8B2C">
                ...
                <div class="card-tools d-flex align-items-center">
                    @can("agent")
                        <a class="btn btn-link text-white mr-4 d-block" wire:click.prevent="goAjouterPermission()"><i
                    ...
                    <tbody>
                        @foreach ($permissions as $permission)
                            <tr>
                                ...
                                @can("agent")
                                    <td>
                                        <button class="btn btn-link" wire:click="goEditPermission({{ $permission->id }})"><i
                                                style="color: green" class="far fa-edit"></i></button>
                                        <button class="btn btn-link" wire:click="confirmDelete({{ $permission->id }})"><i
