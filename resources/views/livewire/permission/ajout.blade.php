...
<div class="form-group">
    ...
    <input type="number" wire:model = "newPermission.sldtotpermi" class="form-control" required>
</div>

<div class="form-group">
    <label>Total Prix</label>
    <input type="number" wire:model = "newPermission.sldeffpermi" value="1" class="form-control" required>
</div>
<div class="form-group">
    <label>Solde restant</label>
    <input type="number" wire:model = "newPermission.sldrstpermi" value="1" class="form-control" required>
</div>
<div class="form-group">
...
<input type="date" wire:model = "newPermission.finpermi" class="form-control" required>
</div>
